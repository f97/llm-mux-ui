...
function SettingsPage() {
  ...
  const { data: proxyData, isLoading: proxyLoading, isError: proxyError } = useProxyUrl()
  const { data: retryData, isLoading: retryLoading, isError: retryError } = useRequestRetry()
  const { data: maxIntervalData, isLoading: maxIntervalLoading, isError: maxIntervalError } = useMaxRetryInterval()
